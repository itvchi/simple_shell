/*
    Simple program which executes command with arguments passed by user using execvp system call
    Passed command and argument should be up to 30 byte long each
*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>
...
int main()
{
    ...
    char* user_imput;
    user_imput = read_line(prompt, stdin);
    char** arglist;
    arglist = tokenize(user_imput);
